      ...
      home: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            Text("Fiorella de Fatima Guadalupe",style: 
            TextStyle(color: Colors.white, fontSize: 26.0,fontWeight: 
            FontWeight.bold,fontFamily: "Dancing"),),
            Text("FLUTTER DEVELOPER", style:
             TextStyle(color: Colors.grey,fontSize: 17.0,letterSpacing: 2.0,fontWeight: 
             FontWeight.w300),),
            ...
            Card(
              ...
              elevation: 55.0,
              child: ListTile(
              title: Text("Jenifer1996_AC@hotmail.com"),
              subtitle: Text("Email"),
